...
import { addPredictionApiCall } from '@/lib/apis';
...
export default function AddPredictionDialog({ open, onOpenChange, onAdd, setPredictions }) {
    ...
    const onSubmit = async (data) => {
        ...
        const res = await addPredictionApiCall(formattedData)
        ...
        if (res?.status === "Success") {
            ...
            onAdd(formattedData, formattedData);
            onOpenChange(false);
            form.reset();
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px] max-w-[92%]">
                <DialogHeader>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-gray-500">
                                Enter exactly 3 numbers between 1 and 49
                            </p>
                        </div>
